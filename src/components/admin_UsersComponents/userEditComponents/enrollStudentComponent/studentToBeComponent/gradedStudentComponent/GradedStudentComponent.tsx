        ...
        <div className='customStudentRegister'>
            {
                ...
                :   <>
                        <div className='innerContentContainer'>
                            <SelectedEditComponentWithAddBtn addBtnAction={() => {}} editActive={true} id='tobeShift' label='Turno' name='ID_Turno' value={state.ID_Turno} onChange={handleState} opts={selectShiftData} key={'tobeShift'}/>
                            ...
                            <SelectedEditComponentWithAddBtn addBtnAction={() => {}} editActive={true} id='tobeCareer' label='Carrera' name='ID_Career' value={state.ID_Career} onChange={handleState} opts={careerOptions} key={'tobeCareer'}/>
                        </div>
