...
export const StudentTypeEditor = ({ RolData, handleActiveEdit, isEditing, editObserver, handleRolEdit, user, user_id }: StudentRol) => {
    ...
    return (
        <DefaultCard hasActionBtn={false} hasTitle={false}>
            ...
            <div style={{marginTop: 20}}>
                <EnrollStudentComponent user_id={user_id} user={user} RolData={RolData}/>
            </div>
        </DefaultCard>
    )
}
